...
func _ready():
	...
	$Tween.interpolate_property($CollisionShape2D.shape, "radius", 1, 500 * speak_range, 0.5, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween.start()
...
func _on_Notification_body_entered(body):
